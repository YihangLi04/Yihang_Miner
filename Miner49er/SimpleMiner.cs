...
namespace Miner49er
{
    ...
    public class SimpleMiner : FSAImpl, Miner
    {
        ...
        public SimpleMiner() : base("SimpleMiner")
        {
            ...
            // set drinking transitions (drink until thirst <= 9, then go mine)
            drinkingState.addTransition("tick",
                new ConditionDelegate[] { new ConditionDelegate(this.thirstAtLeast10) },
                new ActionDelegate[] { new ActionDelegate(this.takeDrink) }, drinkingState);
        ...
        private Boolean thirstAtLeast10(FSA fsa) => thirst >= 10;
        /// <summary>
